      ...
      <div className="space-y-5 lg:col-span-2">
        <div className="p-7 pb-0 block-section">
          ...
          <ul className="flex space-x-8 font-medium">
            ...
            <li>
              <a href="/public/blog.html" className="menu-link menu-link-hover">
                Blog
              </a>
            </li>
          </ul>
          ...
          <div className="mb-5 item-section">
            ...
            <div className="w-full space-y-5">
              ...
              <p className="text-gray-600">
                ...
                voluptatem voluptatibus enim voluptas necessitatibus. Aut quasi
                sunt dolor. Commodi dolores saepe asperiores beatae voluptate
                corporis est ea voluptatem. Enim quo sed et sint aspernatur
                distinctio qui quam.
              </p>
